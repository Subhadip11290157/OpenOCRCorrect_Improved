    ...
    ui(new Ui::MainWindow)
{
   ...
   // str.replace(", ","\t");
    ...
    QMainWindow::setWindowIcon(QIcon(":/Images/logo.png"));
    QAction* subScript = new QAction("Sub", this);
    subScript -> setIcon(QIcon::fromTheme(":/Images/sub.png"));
    subScript->setCheckable(true);
    subScript->setChecked(false);
    connect(subScript, SIGNAL(triggered()), this, SLOT(subscript_Checked()));

    QAction* superScript = new QAction("Super", this);
    superScript -> setIcon(QIcon::fromTheme(":/Images/super.png"));
    ...
    ui -> mainToolBar -> addAction(subScript);
    ui -> mainToolBar -> addAction(superScript);
}
